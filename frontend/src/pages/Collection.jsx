...
const Collection = () => {
  const { productScreenshots, search, showSearch, backendUrl } =
  ...
  const applyFilter = () => {
    let productsCopy = [...productScreenshots];
    ...
    if (subCategory.length > 0) {
      productsCopy = productsCopy.filter((item) =>
        subCategory.includes(item.subCategory) // ✅ fixed typo
      );
    }
  ...
  useEffect(() => {
    applyFilter();
  }, [category, subCategory, search, showSearch, productScreenshots]);
