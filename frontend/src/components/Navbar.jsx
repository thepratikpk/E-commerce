...
const Navbar = () => {
    ...
    const { setShowSearch, getCartCount, isAuthenticated, logout, navigate, authLoading } = useContext(ShopContext);


  return (
    <div className='flex items-center justify-between py-5 font-medium'>
      <Link to='/'><img src={assets.Screenshot20} alt="logo" className="w-36"/></Link>
